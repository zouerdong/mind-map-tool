...
当前处于发布前原生候选验收阶段：G0/G1 已于 2026-08-26、G2 已于 2026-09-08 由项目负责人批准；G-FINAL 尚未申请。技术栈已定：Tauri 2 + React/TypeScript + React Flow 画布 + web-ts-wasm 导出（SVG/2x PNG/PDF），字体 Noto Sans SC（基础）+ LXGW WenKai（手写可选）；v1 发布平台为 macOS（Apple Silicon），Windows 为后续专门版本（移植就绪约束见 PRD §1.1）。PRR-000～067 已完成并独立验收；ADR 0006 v1.1.0 已采用经负责人批准的双指标 cold 协议。source `ea047e8` 的旧 PRR-070 候选因原协议 cold p95 1685.4ms 超过1500ms而作废并只读保留。下一步先完成负责人已选定方案的产品图标生产化与集成，再从新 clean source 完整执行 PRR-070；PRR-080/090 与 G-FINAL 保持阻塞。
